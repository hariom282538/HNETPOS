...
JCheckBox jchFirstName=new JCheckBox();
JCheckBox jchMiddleName=new JCheckBox();
JCheckBox jchLastName=new JCheckBox();
JCheckBox jchRAddress=new JCheckBox();
JCheckBox jchRArea=new JCheckBox();
JCheckBox jchRPin=new JCheckBox();
JCheckBox jchRPhone=new JCheckBox();
JCheckBox jchNAddress=new JCheckBox();
JCheckBox jchNArea=new JCheckBox();
JCheckBox jchNPin=new JCheckBox();
JCheckBox jchNPhone=new JCheckBox();
JCheckBox jchDesignation=new JCheckBox();
JCheckBox jchPayOfDay=new JCheckBox();
JCheckBox jchOverTimePay=new JCheckBox();
JCheckBox jchEmail=new JCheckBox();
JPanel panel0;
JPanel panel1;
...
panel7=new JPanel();
       ...
       panel7.setBorder(new TitledBorder (new LineBorder (Color.blue, 1),"Company Relate Information"));

 panel8=new JPanel();
       panel8.setLayout(new BoxLayout(panel8,BoxLayout.Y_AXIS));
       panel8.setBorder(new TitledBorder (new LineBorder (Color.blue, 1),"Desig-Joining"));
   ...
   //    panel8_1.add(lblBranch);
     //  panel8_1.add(jcbBranch);
       ...
       txtRArea.setEnabled(false);
		txtRPin.setEnabled(false);
		txtRPhone.setEnabled(false);
		txtEmail.setEnabled(false);
        txtNArea.setEnabled(false);
		txtNPin.setEnabled(false);
		txtNPhone.setEnabled(false);	
        txtRAddress.setEnabled(false);  		
	     txtNAddress.setEnabled(false);
	     txtDesignation.setEnabled(false);
	     txtPayOfDay.setEnabled(false);
	      txtOverTimePay.setEnabled(false);
